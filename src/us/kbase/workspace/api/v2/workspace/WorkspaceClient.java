...
public class WorkspaceClient {
    ...
    static {
        try {
            DEFAULT_URL = new URL("https://kbase.us/services/ws/api/v2");
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public String aV2Function() throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        TypeReference<List<String>> retType = new TypeReference<List<String>>() {};
        List<String> res = caller.jsonrpcCall("Workspace.a_v2_function", args, retType, true, false);
        return res.get(0);
    }
